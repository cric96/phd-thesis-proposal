...
\abstract{
	...
	%
	Inspired by nature, we define the notion of ``Cypher-Physical Swarms'' -- the extension of `swarms' in computer science.
	%
...
%
These consider systems (typically \emph{cypher physical}) where a large number (hundreds - thousands - millions) of simple interacting devices collectively perform complicated tasks in a decentralised manner, acting and sensing through a shared environment. 
%
