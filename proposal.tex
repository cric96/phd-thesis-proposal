...
\abstract{
This document expands my PhD project proposal entitled Engineering Cyber-Physical Swarms with Aggregate Computing. In particular, this thesis aims to define a path towards the engineering of Cypher-Physical Swarms (CPSWs) - where swarms are seen in a modern key, including swarm robotics, large-scale IoT scenarios, and crowd engineering (tracking and control). 
%
...
%
As a final result of my PhD, we intend to analyse the application of Aggregate Computing in CPSWs. This will touch on several aspects like distributed intelligence, flexible and opportunistic middlewares, building blocks and ad-hoc DSL.
