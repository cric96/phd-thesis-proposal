...
\begin{itemize}
	...
	the aggregate programs are expressed through manipulation of computational fields, abstracting over nodes itself and treating the system like a computational blob that evolves in time. 
	%
...
%
Great strides have been made in research from a foundational point of view, but an all-encompassing approach to the design and implementation of collective programs is still lacking, and this is the point where my thesis will focus on (\Cref{fig:current-state}).
%
In particular, my work will be focused at:
\begin{itemize}
