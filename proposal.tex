...
\abstract{
	...
	%
	As a final result of my PhD, we intend to analyse the application of Aggregate Computing in \cpsw{}. This will touch on several aspects like distributed intelligence, flexible and opportunistic middlewares, building blocks and ad-hoc API.
}
\newpage
\tableofcontents
...
%% We are in particular interested in the application of learning in such kind of system, due to the different typically single agent perspective
